...
The Shiny App can be found [here](www.google.com) and the coding can be found
[here](www.google.com).
...
file to compare to the three words inputted by the user and see if any matched.
If not, then it would look at the trigam file and look at the two words the user
inputted to see if any matched. If not, this same process was repeated for the 
bigram and the unigram files t osee if any matched.
